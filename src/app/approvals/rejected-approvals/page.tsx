import { RejectedRequestRow } from "@/app/components/RejectedRequestRow";
...
export default async function RejectedApprovals() {
  ...
  const approvedRequests = await db
    ...
    .where(eq(leaveRequests.status, "tm_rejected"));

  return (
    <div className="container mx-auto py-8 px-4 space-y-6">
      <h1 className="text-2xl font-bold">Top Management Rejected Leave Requests</h1>
